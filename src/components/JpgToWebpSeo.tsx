  ...
  step: [
    {
      ...
      text: "Open the JPG to WebP converter on FreePDFHub. No signup, no account, no install needed.",
      url: `${url}#step-1`,
    },
    {
      "@type": "HowToStep",
...
export const jpgToWebpFaqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. If you ever need a JPG copy of the WebP, use the WebP to JPG tool in the FreePDFHub image toolbox. It is also 100 percent browser-based.",
      },
    },
    {
      "@type": "Question",
