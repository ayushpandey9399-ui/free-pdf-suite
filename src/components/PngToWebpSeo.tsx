  ...
  step: [
    {
      ...
      text: "Open the PNG to WebP converter on FreePDFHub. No signup, no account, no install needed.",
      url: `${url}#step-1`,
    },
    {
      "@type": "HowToStep",
...
export const pngToWebpFaqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. If you ever need a PNG copy of the WebP, use the WebP to PNG tool in the FreePDFHub image toolbox. It also preserves transparency, and it is 100 percent browser-based.",
      },
    },
    {
      "@type": "Question",
