...
export function AddBlankPagesSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      ...
      <p className="mt-4 text-[15px] leading-relaxed text-[#4a4a55]">
        Like every pdftoolconverteronline.com tool, the insertion runs entirely inside your
...
export const addBlankPagesHowToJsonLd = {
  ...
  tool: [{ "@type": "HowToTool", name: "pdftoolconverteronline.com Add Blank Pages (web browser)" }],
  step: steps.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
    name: s.title,
