...
export function HeicToJpgSeo() {
  return (
    <section className="mx-auto mt-16 max-w-3xl px-4 text-[15px] leading-relaxed text-[#33333c]">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]" id="step-2">Step 2 — Set Quality Options</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]" id="step-4">Step 4 — Download Your JPG Files</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Uploading Photos to Websites and Portals</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Printing at Photo Labs</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Editing in Photo Software</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Sharing on Social Media</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Attaching to Emails on Windows</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Using Photos in Office Documents</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Submitting ID Photos and Document Scans</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Set iPhone to Capture in JPG Directly</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Compress After Converting for Uploads</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Convert to PNG for Transparent Backgrounds</h2>
      <p className="mt-2">
      ...
      <h3 className="mt-6 text-[18px] font-bold text-[#383E45]">Resize After Converting for Specific Requirements</h2>
      <p className="mt-2">
