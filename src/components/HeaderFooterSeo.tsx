...
const steps = [
  ...
  },
  {
    ...
    text: "Pick a Font size (6–72pt, default 10), a Color from the swatch picker, and a Margin from edge — Small (18pt), Normal (28pt) or Big (44pt). Under Pages, choose All pages or Page range and type something like 2-10 or 1,3,5-9 to skip a cover page or target a specific section.",
  },
  {
...
export function HeaderFooterSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      <BenefitBadges items={["Files never leave your device", "Six positions + smart tokens like {page} and {date}", "Free, no signup, no watermark"]} />
...
export const headerFooterHowToJsonLd = {
  ...
  tool: [{ "@type": "HowToTool", name: "PDFfree Header & Footer (web browser)" }],
  step: steps.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
    name: s.title,
...
export const headerFooterSoftwareJsonLd = {
  ...
  name: "PDFfree Add Header & Footer",
  description:
