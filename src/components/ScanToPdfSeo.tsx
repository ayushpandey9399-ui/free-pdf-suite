...
export function ScanToPdfSeo() {
  return (
    <div className="mx-auto mt-16 max-w-3xl space-y-12 text-[15px] leading-relaxed" style={{ color: "#33333c" }}>
      ...
      <section>
        <h2 className="text-2xl font-bold">No scanner? No app? No problem.</h3>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-bold">Clean, flat, readable, even from a phone photo</h3>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-2xl font-bold">The private scanner in your pocket</h3>
        <p className="mt-3">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div>
          <h4 className="text-lg font-bold">Multi-page documents</h3>
        ...
        <div>
          <h4 className="text-lg font-bold">Retake until it's right</h3>
          <p className="mt-1 text-sm">
        ...
        <div>
          <h4 className="text-lg font-bold">Works on any phone</h3>
          <p className="mt-1 text-sm">
        ...
        <div>
          <h4 className="text-lg font-bold">Straight into your workflow</h3>
          <p className="mt-1 text-sm">
      ...
      <section>
        <h2 className="text-2xl font-bold">When do you need to scan to PDF?</h3>
        <div className="mt-4 space-y-4">
          <div>
            <h4 className="text-lg font-bold">Submitting IDs and certificates to online portals</h3>
            <p className="mt-1 text-sm">
          ...
          <div>
            <h4 className="text-lg font-bold">Digitising signed agreements and receipts</h3>
            <p className="mt-1 text-sm">
          ...
          <div>
            <h4 className="text-lg font-bold">Sending homework and forms when there's no scanner</h3>
            <p className="mt-1 text-sm">
          ...
          <div>
            <h4 className="text-lg font-bold">Archiving paper before it fades</h3>
            <p className="mt-1 text-sm">
      ...
      <section>
        <h2 className="text-2xl font-bold">Frequently asked questions</h3>
        <div className="mt-4 space-y-4">
          {scanToPdfFaq.map((f) => (
            <div key={f.q}>
              <h4 className="font-bold">{f.q}</h3>
