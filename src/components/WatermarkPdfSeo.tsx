  ...
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      ...
      <ol className="mt-5 space-y-4">
        {steps.map((s, i) => (
          <li key={i} id={`step-${i + 1}`} className="flex gap-4">
            ...
            <div className="pt-1">
              <h4 className="text-[17px] font-semibold">{s.title}</h4>
      ...
      <div className="mt-6 space-y-6">
        <div>
          <h4 className="text-[18px] font-bold text-[#1F2937]">Text Watermark</h4>
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#1F2937]">Image Watermark</h4>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
      ...
      <div className="mt-6 space-y-6">
        <div>
          <h4 className="text-[17px] font-semibold">1. Business Documents</h4>
        ...
        <div>
          <h4 className="text-[17px] font-semibold">2. Confidential Reports</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold">3. Draft Documents</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold">4. Copyright Protection</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold">5. Invoice Branding</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold">6. Legal Documents</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold">7. Real Estate Listings</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold">8. Academic Work</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
      ...
      <div className="mt-6 space-y-5">
        <div>
          <h4 className="text-[17px] font-semibold text-[#1F2937]">Keep Background Colors in Mind</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold text-[#1F2937]">Use PNG for Image Logos</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold text-[#1F2937]">Don't Over-Rotate</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold text-[#1F2937]">Check Every Page</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[17px] font-semibold text-[#1F2937]">Combine with Password Protection</h4>
          <p className="mt-1 text-[14.5px] leading-relaxed text-[#4a4a55]">
