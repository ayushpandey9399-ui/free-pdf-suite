...
export function PhotoEditorSeo() {
  return (
    <section className="mx-auto mt-16 max-w-3xl text-[15px] leading-[1.75] text-[#33333c]">
      <h2 className="mb-3 text-[24px] font-bold text-[#1F2937]">How to edit a photo online, free</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Crop, rotate, and straighten in one place</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Adjust brightness, contrast, and color</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Duotone color grading</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">One-tap filters, B&W, sepia, vintage, and more</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Fix a dark or washed-out photo</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Before and after compare</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Export as JPG, PNG, or WebP</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Your photo never leaves your device</h3>
      <p>
      ...
      <h2 className="mt-8 mb-3 text-[22px] font-bold text-[#1F2937]">Works on Windows, Mac, Android, and iPhone</h3>
      <p>
      ...
      <h2 className="mt-10 mb-4 text-[22px] font-bold text-[#1F2937]">Frequently asked questions</h3>
