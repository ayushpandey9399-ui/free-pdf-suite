...
export function PdfMetadataSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      <BenefitBadges items={["Files never leave your device", "View, edit or clear all properties", "Free, no signup, no watermark"]} />
...
export const pdfMetadataHowToJsonLd = {
  ...
  tool: [{ "@type": "HowToTool", name: "PDFfree PDF Metadata Editor (web browser)" }],
  step: steps.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
    name: s.title,
...
export const pdfMetadataSoftwareJsonLd = {
  ...
  name: "PDFfree PDF Metadata Editor",
  description:
