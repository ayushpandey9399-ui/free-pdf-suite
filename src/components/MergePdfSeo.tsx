...
export function MergePdfSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 seo-content">
      ...
      <div className="mt-5 space-y-6">
        {steps.map((s, i) => (
          <div key={i} className="flex gap-4">
            ...
            <div className="pt-1">
              <h4 className="text-[18px] font-bold text-[#33333c]">{s.title}</h3>
      ...
      <div className="mt-5 space-y-6">
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Combine Project Reports for Stakeholders</h3>
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Merge Legal Documents and Case Files</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Consolidate Invoices and Financial Records</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Build a Student Portfolio or Thesis</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Prepare Rental or Visa Applications</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Combine Scanned Pages Into One Document</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Organize Travel Documents</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Create Unified Training or Course Materials</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
      ...
      <div className="mt-5 space-y-6">
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Your Files Never Leave Your Device</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Completely Free With No Hidden Limits</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">No Quality Loss</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Drag-and-Drop Reordering</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Works on Every Device and Browser</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Lightning-Fast Processing</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
      ...
      <div className="mt-5 space-y-6">
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Name Your Files Before Merging</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Check Page Orientation Consistency</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Remove Unnecessary Pages First</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Compress After Merging for Smaller File Size</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        <div>
          <h4 className="text-[18px] font-bold text-[#33333c]">Use Blank Pages as Section Dividers</h3>
          <p className="mt-2 text-[15px] leading-relaxed text-[#4a4a55]">
