...
const faqs = [
  {
    ...
    a: "Yes. pdftoolconverteronline.com merges PDFs directly in your browser using client-side JavaScript and WebAssembly. Your files are opened, combined and saved on your own device, nothing is uploaded, so even confidential contracts, medical records or bank statements never leave your computer.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. pdftoolconverteronline.com works in any modern mobile browser on Android and iPhone. There is no app to install and no permissions to grant, just open the page, pick your PDFs and download the merged file.",
  },
  {
    q: "Do I need an account or email?",
    a: "No. There is no signup, no email required and no watermark added to the output. Every tool on pdftoolconverteronline.com is free to use as often as you like.",
  },
  {
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      ...
      <p className="mt-4 text-[15px] leading-relaxed text-[#4a4a55]">
        ...
        after some time, you have to trust that they actually do. pdftoolconverteronline.com is different. Merging happens entirely in
...
export const mergeHowToJsonLd = {
  ...
  tool: [{ "@type": "HowToTool", name: "pdftoolconverteronline.com Merge PDF (web browser)" }],
  step: steps.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
    name: s.title,
