...
export function RedactPdfSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      <BenefitBadges items={["Files never leave your device", "True redaction, content permanently removed", "Free, no signup, no watermark"]} />
...
export const redactHowToJsonLd = {
  ...
  tool: [{ "@type": "HowToTool", name: "PDFfree Redact PDF (web browser)" }],
  step: steps.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
    name: s.title,
