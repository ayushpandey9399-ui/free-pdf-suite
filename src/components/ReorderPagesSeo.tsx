...
export function ReorderPagesSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 seo-content">
      ...
      <h3>How to reorder PDF pages — Step by Step</h4>
      ...
      <h3>Common causes of wrong page order</h4>
      <h3>Scanning pages out of sequence</h4>
      ...
      <h3>Merging PDFs from different sources</h4>
      ...
      <h3>Exporting from design software</h4>
      ...
      <h3>Combining documents from multiple contributors</h4>
      ...
      <h3>8 use cases for reordering PDF pages</h4>
      <h3>Fixing scanned documents</h4>
      ...
      <h3>Reordering book chapters</h4>
      ...
      <h3>Fixing presentation exports</h4>
      ...
      <h3>Academic paper organization</h4>
      ...
      <h3>Reorder vs Split vs Delete pages — what is the difference?</h4>
      ...
      <h3>Browser-based vs server-based comparison</h4>
      ...
      <h3>5 tips for reordering PDF pages</h4>
      <h3>Use the visual grid</h4>
      ...
      <h3>Reorder large files in sections</h4>
      ...
      <h3>Double-check the first and last pages</h4>
      ...
      <h3>Combine with other tools</h4>
