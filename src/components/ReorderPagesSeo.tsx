...
export function ReorderPagesSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 seo-content">
      ...
      <h2>How to reorder PDF pages — Step by Step</h3>
      ...
      <h2>Scanning pages out of sequence</h3>
      ...
      <h2>Merging PDFs from different sources</h3>
      ...
      <h2>Exporting from design software</h3>
      ...
      <h2>Combining documents from multiple contributors</h3>
      ...
      <h2>8 use cases for reordering PDF pages</h3>
      <h2>Fixing scanned documents</h3>
      ...
      <h2>Reordering book chapters</h3>
      ...
      <h2>Fixing presentation exports</h3>
      ...
      <h2>Academic paper organization</h3>
      ...
      <h2>Reorder vs Split vs Delete pages — what is the difference?</h3>
      ...
      <h2>5 tips for reordering PDF pages</h3>
      <h2>Use the visual grid</h3>
      ...
      <h2>Reorder large files in sections</h3>
      ...
      <h2>Double-check the first and last pages</h3>
      ...
      <h2>Combine with other tools</h3>
