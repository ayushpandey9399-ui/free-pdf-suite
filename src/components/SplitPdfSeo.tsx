...
export function SplitPdfSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 seo-content">
      {/* Section A */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Why Would You Need to Split a PDF File?</h4>
      ...
      {/* Section B - How-to */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">How to Split a PDF Online — Step by Step</h4>
      <ol className="mt-5 space-y-4">
        {steps.map((s, i) => (
          <li key={i} id={`step-${i + 1}`} className="flex gap-4">
            ...
            <div className="pt-1">
              <h4 className="text-lg font-semibold text-[#383E45]">{s.title}</h4>
      ...
      {/* Section C */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Three Ways to Split a PDF</h4>
      <h4 className="mt-6 text-lg font-semibold text-[#383E45]">Split by Page Range</h4>
      ...
      <h4 className="mt-6 text-lg font-semibold text-[#383E45]">Extract Every Page as a Separate PDF</h4>
      <p className="mt-2 text-base leading-relaxed text-[#383E45]">
      ...
      <h4 className="mt-6 text-lg font-semibold text-[#383E45]">Extract Specific Pages</h4>
      <p className="mt-2 text-base leading-relaxed text-[#383E45]">
      ...
      {/* Section D */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Common Scenarios for Splitting PDF Files</h4>
      <div className="mt-6 space-y-6">
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Split a Large Report Into Chapters</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Extract Individual Invoices from a Batch PDF</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Separate Pages Before Distributing to Recipients</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Split Scanned Documents Into Individual Forms</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Reduce File Size for Upload Limits</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Extract Evidence or Exhibits for Legal Filings</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Create Chapter Previews or Samples</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Organize Scanned Archives by Topic</h4>
      ...
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Browser-Based vs Server-Based PDF Splitting</h4>
      ...
      {/* Section F - Tips */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Tips for Splitting PDFs Effectively</h4>
      <div className="mt-6 space-y-6">
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Know Your Page Numbers Before Splitting</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Compress After Splitting</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Merge Specific Pages Before Splitting</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Use Delete Pages for Simple Trimming</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-[#383E45]">Rename Output Files Immediately</h4>
      ...
      {/* FAQ */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Frequently Asked Questions About Splitting PDFs</h4>
      ...
      {/* Related */}
      <h2 className="mt-14 text-2xl font-bold text-[#383E45]">Related PDF Tools</h4>
