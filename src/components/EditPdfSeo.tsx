...
export function EditPdfSeo() {
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 seo-content">
      ...
      <h3>How to edit a PDF — Step by Step</h4>
      ...
      <h3>What can you edit in a PDF?</h4>
      <h3>Add text and text boxes</h4>
