...
export const webpToJpgSoftwareJsonLd = {
    ...
    description: "Convert WebP images to JPG online instantly in your browser. Batch convert multiple WebP files to JPEG. Free, no signup, no watermark, files never leave your device.",
};
export const webpToJpgHowToJsonLd = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "How to convert WebP to JPG",
    description: "Convert WebP images to universal JPG files online, free, entirely in your browser.",
    totalTime: "PT1M",
    step: [
        {
            "@type": "HowToStep",
...
export function WebpToJpgSeo() {
    return (<section className="mx-auto mt-16 max-w-3xl px-4 text-[15px] leading-relaxed text-[#33333c]">
      ...
      <dl className="mt-4 space-y-4">
        {webpToJpgFaqJsonLd.mainEntity.map((q, i) => (<div key={i} className="rounded-lg border border-[#ececef] p-4">
