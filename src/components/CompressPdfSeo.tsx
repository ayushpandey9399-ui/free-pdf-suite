    ...
    <section className="seo-content mx-auto max-w-4xl px-4 pb-16">
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-[#383E45]">Step 2 — Choose Your Compression Level</h2>
            <p className="mt-2 text-base leading-relaxed text-[#383E45]">
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-[#383E45]">Step 3 — Compress the PDF</h2>
            <p className="mt-2 text-base leading-relaxed text-[#383E45]">
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h3 className="text-lg font-bold text-[#383E45]">Step 4 — Download the Compressed File</h2>
            <p className="mt-2 text-base leading-relaxed text-[#383E45]">
