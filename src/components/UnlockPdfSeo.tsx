  ...
  return (
    <section className="mx-auto max-w-4xl px-4 pb-16 text-[#33333c]">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-3">
        {[
          "File and password never leave your device",
          "Permanent — enter the password once, never again",
...
export const unlockHowToJsonLd = {
  ...
  tool: [{ "@type": "HowToTool", name: "PDFfree Unlock PDF (web browser)" }],
  step: steps.map((s, i) => ({
    "@type": "HowToStep",
    position: i + 1,
    name: s.title,
