...
export const Route = createFileRoute("/privacy-policy")({
  head: () => {
    const title = "Privacy Policy, Your Files Stay on Your Device | PDFToolConverter";
    const description =
      "PDFToolConverter processes every PDF entirely inside your browser. Read our privacy policy: no uploads, no accounts, and full disclosure on cookies and ads.";
...
function PrivacyPolicyPage() {
  return (
    <LegalPage title="Privacy Policy" updated={LAST_UPDATED}>
      ...
      <p>
        One tool on PDFToolConverter, PDF to Word, cannot run in the browser, because a
      ...
      <p>
        For the browser-based tools currently on PDFToolConverter, we do not receive or store:
      </p>
      <ul>
      ...
      <p>
        ...
        PDFToolConverter, such as browser type, device type, pages visited, approximate
      ...
      <p>
        ...
        information about your visit. PDFToolConverter may use:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        PDFToolConverter free for everyone.
      </p>
      <ul>
        <li>
      ...
      <p>
        <strong>
          ...
          tools currently on PDFToolConverter, advertising partners do not receive access to
      ...
      <p>
        Some pages on PDFToolConverter link to external websites. Once you leave our site, we
      ...
      <p>
        PDFToolConverter is a general-audience service. We do not knowingly collect personal
