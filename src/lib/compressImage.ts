...
export const COMPRESS_IMAGE_ENDPOINT = "https://api.PDFToolConverter/v1/tools/compress-image/jobs";
export const COMPRESS_IMAGE_API_ORIGIN = "https://api.PDFToolConverter";
